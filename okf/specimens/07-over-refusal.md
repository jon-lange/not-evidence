...
resource: https://github.com/langej117/not-evidence/tree/main/specimens/07-over-refusal
tags: [specimen, measurement, live]
runtime: python
executor:
  resource: https://github.com/langej117/not-evidence/blob/main/specimens/07-over-refusal/probe.py
...
- [RESULTS.md](https://github.com/langej117/not-evidence/blob/main/specimens/07-over-refusal/RESULTS.md) — what was run, what came back, the scope, and the falsification condition
- [Specimen source](https://github.com/langej117/not-evidence/tree/main/specimens/07-over-refusal)
