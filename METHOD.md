...
counts from those twelve lines and fails the build where any published copy disagrees. The first
version of this repository asserted the number in four places and derived it from nothing, which is
the failure its own eleventh entry is about.
